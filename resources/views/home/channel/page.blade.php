            ...
            <div class="container">
                <div class="grid-head" style="text-align: center">
                    <h2 class="title" style="text-align: center" data-cms="{{ app()->getLocale() }}-channel-index-5">Danh
                        sách Fanpage!</h2>
                    <div class="sapo">
                        <p data-cms="{{ app()->getLocale() }}-channel-index-6">Vui lòng liên hệ với chúng tôi qua email hoặc
                            hotline.</p>
                    </div>
                </div>
                                ...
                                <div class="row" style="margin-bottom: 20px;">
                                    ...
                                    <div class="col-12" id="box-filter"
                                        ...
                                        <button id="reset" type="submit"
                                            style="background-color: #E1CE69; border: 1px solid #E1CE69; margin-right: 10px;  box-shadow: 0 3px 5px -1px rgb(0 0 0 / 20%), 0 6px 10px 0 rgb(0 0 0 / 14%),
                                ...
                                @for ($i = 1; $i < count($values); $i++)
                                    <tr>
                                        ...
                                        0 1px 18px 0 rgb(0 0 0 / 12%); padding: 5px 10px; margin: 5px; min-width: 61px;"
                                                onclick="copy('link_{{ $i }}')">Xem fanpage</button>
                                            <button
